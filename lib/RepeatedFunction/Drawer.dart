      ...
      child: Container(
        ...
        child: ListView(
          children: [
              ...
              showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      backgroundColor: Color.fromRGBO(18, 18, 18, 0.9),
                      title: overviewtext(
                          'This App is made by Anket Kadam.User can explore,get Details of latest Movies/series.TMDB API is used to fetch data.'),
                      actions: [
                        TextButton(
                            onPressed: () {
                              Navigator.pop(context);
            ...
            listtilefunc('Sign Out', Icons.exit_to_app_rounded, ontap: () {
              _auth.signOut;
            }),
